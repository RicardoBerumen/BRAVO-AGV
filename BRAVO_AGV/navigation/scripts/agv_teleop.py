...
AGV_MAX_LIN_VEL = 0.22
AGV_MAX_ANG_VEL = 2.84
...
def check_linear_limit_velocity(velocity):
    return constrain(velocity, -AGV_MAX_LIN_VEL, AGV_MAX_LIN_VEL)


def check_angular_limit_velocity(velocity):
    return constrain(velocity, -AGV_MAX_ANG_VEL, AGV_MAX_ANG_VEL)
