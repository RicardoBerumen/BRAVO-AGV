...
class Orbbec_Det(Node):
    """
    A node with a single publisher.

    This class creates a node which publishes the position of an object with x, y, z
    """
    def __init__(self):
        # Calls Node.__init__('talker')
        super().__init__('orbbec_det')
        self.i = 0
